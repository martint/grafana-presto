...
Note: This is a fork of Grafana with Presto Database support. [Presto](http://prestosql.io/) can be used as a metric data source and annotation source. For dashboard storage, HTML5 local storage is used to store and search dashboards.
